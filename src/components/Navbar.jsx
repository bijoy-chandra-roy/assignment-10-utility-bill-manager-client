    ...
    <div className="navbar px-4">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={-1}
            className="menu menu-sm dropdown-content mt-3 w-52 p-2 bg-base-100 rounded-box"
          >
            {pages}
            {!user && (
              <>
      ...
      <div className="navbar-end">
        ...
        {user && (
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={-1}
              className="menu menu-sm dropdown-content mt-3 p-2 w-auto min-w-max bg-base-100 rounded-box"
            >
              <li>
